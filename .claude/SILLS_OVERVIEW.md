...
# HBC Project Controls – Active Skills Index (9 Consolidated Skills)
...
| tanstack-router-stability-spfx             | router       | tanstack router, router stability, useRef router, router recreation, navigation freeze, project picker freeze, router.update, updateContext | Stable singleton pattern for TanStack Router v1 preventing route-tree recreation and UI freezes on AppContext (selectedProject, currentUser, permissions, feature flags) changes in SPFx |
