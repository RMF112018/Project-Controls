...
#### CLAUDE.md Sections to Update
- `§15` (a11y metrics)
- `§16` (update feature flag list, remove dead flags)

#### SKILL.md Files
- Update `elevated-ux-ui-design/SKILL.md` with a11y verification checklist
- Create new `accessibility-compliance/SKILL.md` if a11y rules exceed 10 items (otherwise fold into elevated-ux-ui-design)
...
#### CLAUDE.md Sections to Update
- `§1` (add @hbc/ui-components to tech stack)
- `§4` (add package architecture)
- `§16` (add component library pitfalls)

#### SKILL.md Files
- Create `hbc-ui-components/SKILL.md` v1.0 — component extraction rules, design token sharing, Gen 1/2/3 compatibility
- Update `child-app-structure/SKILL.md` with package dependency rules
- Update `spfx-performance-diagnostics-and-bundle/SKILL.md` with chunk isolation audit procedure
...
#### CLAUDE.md Sections to Update
- `§0` (add CI gate references to verification commands)
- `§16` (add CI/CD pitfalls)

#### SKILL.md Files
- Update `hbc-testing-coverage-enforcement-spfx/SKILL.md` with CI gate procedures
- Consider new `ci-cd-quality-gates/SKILL.md` if rules exceed 10 items
...
Cross-references:
- `.claude/plans/hbc-stabilization-and-suite-roadmap.md` — this file (master plan)
- `CLAUDE.md §15` — current phase status
- `CLAUDE.md §18` — roadmap timeline
