...
**Last Updated:** 2026-02-15 — SP-7: SharePointDataService Chunk 7 — 7 PMP stubs→implementations (176 of 221 total)
...
│   │   ├── SharePointDataService.ts # SP implementation (169 impl, 46 stubs, 6 delegation)
...
| 78 | getRiskCostManagement | (projectCode: string) → Promise<IRiskCostManagement \| null> | Impl | Impl | useRiskCostManagement | riskCostManagement.json |
| 79 | updateRiskCostManagement | (projectCode: string, data: Partial<IRiskCostManagement>) → Promise<IRiskCostManagement> | Impl | Impl | useRiskCostManagement | riskCostManagement.json |
| 80 | addRiskCostItem | (projectCode: string, item: Partial<IRiskCostItem>) → Promise<IRiskCostItem> | Impl | Impl | useRiskCostManagement | riskCostManagement.json |
| 81 | updateRiskCostItem | (projectCode: string, itemId: number, data: Partial<IRiskCostItem>) → Promise<IRiskCostItem> | Impl | Impl | useRiskCostManagement | riskCostManagement.json |
| 82 | getQualityConcerns | (projectCode: string) → Promise<IQualityConcern[]> | Impl | Impl | useQualityConcerns | qualityConcerns.json |
| 83 | addQualityConcern | (projectCode: string, concern: Partial<IQualityConcern>) → Promise<IQualityConcern> | Impl | Impl | useQualityConcerns | qualityConcerns.json |
| 84 | updateQualityConcern | (projectCode: string, concernId: number, data: Partial<IQualityConcern>) → Promise<IQualityConcern> | Impl | Impl | useQualityConcerns | qualityConcerns.json |
| 85 | getSafetyConcerns | (projectCode: string) → Promise<ISafetyConcern[]> | Impl | Impl | useSafetyConcerns | safetyConcerns.json |
| 86 | addSafetyConcern | (projectCode: string, concern: Partial<ISafetyConcern>) → Promise<ISafetyConcern> | Impl | Impl | useSafetyConcerns | safetyConcerns.json |
| 87 | updateSafetyConcern | (projectCode: string, concernId: number, data: Partial<ISafetyConcern>) → Promise<ISafetyConcern> | Impl | Impl | useSafetyConcerns | safetyConcerns.json |
| 88 | getProjectSchedule | (projectCode: string) → Promise<IProjectScheduleCriticalPath \| null> | Impl | Impl | useProjectSchedule | projectScheduleCriticalPath.json |
| 89 | updateProjectSchedule | (projectCode: string, data: Partial<IProjectScheduleCriticalPath>) → Promise<IProjectScheduleCriticalPath> | Impl | Impl | useProjectSchedule | projectScheduleCriticalPath.json |
| 90 | addCriticalPathItem | (projectCode: string, item: Partial<ICriticalPathItem>) → Promise<ICriticalPathItem> | Impl | Impl | useProjectSchedule | projectScheduleCriticalPath.json |
| 91 | getSuperintendentPlan | (projectCode: string) → Promise<ISuperintendentPlan \| null> | Impl | Impl | useSuperintendentPlan | superintendentPlan.json |
| 92 | updateSuperintendentPlanSection | (projectCode: string, sectionId: number, data: Partial<ISuperintendentPlanSection>) → Promise<ISuperintendentPlanSection> | Impl | Impl | useSuperintendentPlan | superintendentPlan.json |
| 93 | createSuperintendentPlan | (projectCode: string, data: Partial<ISuperintendentPlan>) → Promise<ISuperintendentPlan> | Impl | Impl | useSuperintendentPlan | superintendentPlan.json |
| 94 | getLessonsLearned | (projectCode: string) → Promise<ILessonLearned[]> | Impl | Impl | useLessonsLearned | lessonsLearned.json |
| 95 | addLessonLearned | (projectCode: string, lesson: Partial<ILessonLearned>) → Promise<ILessonLearned> | Impl | Impl | useLessonsLearned, usePostBidAutopsy | lessonsLearned.json |
| 96 | updateLessonLearned | (projectCode: string, lessonId: number, data: Partial<ILessonLearned>) → Promise<ILessonLearned> | Impl | Impl | useLessonsLearned | lessonsLearned.json |
| 97 | getProjectManagementPlan | (projectCode: string) → Promise<IProjectManagementPlan \| null> | Impl | Impl | useProjectManagementPlan | projectManagementPlans.json |
| 98 | updateProjectManagementPlan | (projectCode: string, data: Partial<IProjectManagementPlan>) → Promise<IProjectManagementPlan> | Impl | Impl | useProjectManagementPlan | projectManagementPlans.json |
| 99 | submitPMPForApproval | (projectCode: string, submittedBy: string) → Promise<IProjectManagementPlan> | Impl | Impl | useProjectManagementPlan | projectManagementPlans.json |
| 100 | respondToPMPApproval | (projectCode: string, stepId: number, approved: boolean, comment: string) → Promise<IProjectManagementPlan> | Impl | Impl | useProjectManagementPlan | projectManagementPlans.json |
| 101 | signPMP | (projectCode: string, signatureId: number, comment: string) → Promise<IProjectManagementPlan> | Impl | Impl | useProjectManagementPlan | projectManagementPlans.json |
| 102 | getDivisionApprovers | () → Promise<IDivisionApprover[]> | Impl | Impl | useProjectManagementPlan | divisionApprovers.json |
| 103 | getPMPBoilerplate | () → Promise<IPMPBoilerplateSection[]> | Impl | Impl | useProjectManagementPlan | pmpBoilerplate.json |
...
| 108 | getEstimatingKickoff | (projectCode: string) → Promise<IEstimatingKickoff \| null> | Impl | Impl | useEstimatingKickoff | estimatingKickoffs.json |
| 109 | getEstimatingKickoffByLeadId | (leadId: number) → Promise<IEstimatingKickoff \| null> | Impl | Impl | useEstimatingKickoff | estimatingKickoffs.json |
| 110 | createEstimatingKickoff | (data: Partial<IEstimatingKickoff>) → Promise<IEstimatingKickoff> | Impl | Impl | useEstimatingKickoff | estimatingKickoffs.json |
| 111 | updateEstimatingKickoff | (id: number, data: Partial<IEstimatingKickoff>) → Promise<IEstimatingKickoff> | Impl | Impl | useEstimatingKickoff | estimatingKickoffs.json |
| 112 | updateKickoffItem | (kickoffId: number, itemId: number, data: Partial<IEstimatingKickoffItem>) → Promise<IEstimatingKickoffItem> | Impl | Impl | useEstimatingKickoff | estimatingKickoffs.json |
| 113 | addKickoffItem | (kickoffId: number, item: Partial<IEstimatingKickoffItem>) → Promise<IEstimatingKickoffItem> | Impl | Impl | useEstimatingKickoff | estimatingKickoffs.json |
| 114 | removeKickoffItem | (kickoffId: number, itemId: number) → Promise<void> | Impl | Impl | useEstimatingKickoff | estimatingKickoffs.json |
| 173 | updateKickoffKeyPersonnel | (kickoffId: number, personnel: IKeyPersonnelEntry[]) → Promise<IEstimatingKickoff> | Impl | Impl | useEstimatingKickoff | estimatingKickoffs.json |
| 115 | getJobNumberRequests | (status?: JobNumberRequestStatus) → Promise<IJobNumberRequest[]> | Impl | Impl | useJobNumberRequest | jobNumberRequests.json |
| 116 | getJobNumberRequestByLeadId | (leadId: number) → Promise<IJobNumberRequest \| null> | Impl | Impl | useJobNumberRequest | jobNumberRequests.json |
| 117 | createJobNumberRequest | (data: Partial<IJobNumberRequest>) → Promise<IJobNumberRequest> | Impl | Impl | useJobNumberRequest | jobNumberRequests.json |
| 118 | finalizeJobNumber | (requestId: number, jobNumber: string, assignedBy: string) → Promise<IJobNumberRequest> | Impl | Impl | useJobNumberRequest | jobNumberRequests.json |
| 119 | getProjectTypes | () → Promise<IProjectType[]> | Impl | Impl | useJobNumberRequest | projectTypes.json |
| 120 | getStandardCostCodes | () → Promise<IStandardCostCode[]> | Impl | Impl | useJobNumberRequest | standardCostCodes.json |
...
| 190 | getSectorDefinitions | () → Promise<ISectorDefinition[]> | Impl | Impl | useSectorDefinitions | sectorDefinitions.json |
| 191 | createSectorDefinition | (data: Partial<ISectorDefinition>) → Promise<ISectorDefinition> | Impl | Impl | AdminPanel | sectorDefinitions.json |
| 192 | updateSectorDefinition | (id: number, data: Partial<ISectorDefinition>) → Promise<ISectorDefinition> | Impl | Impl | AdminPanel | sectorDefinitions.json |
...
| 197 | getAssignmentMappings | () → Promise<IAssignmentMapping[]> | Impl | Impl | useAssignmentMappings | assignmentMappings.json |
| 198 | createAssignmentMapping | (data: Partial<IAssignmentMapping>) → Promise<IAssignmentMapping> | Impl | Impl | useAssignmentMappings | assignmentMappings.json |
| 199 | updateAssignmentMapping | (id: number, data: Partial<IAssignmentMapping>) → Promise<IAssignmentMapping> | Impl | Impl | useAssignmentMappings | assignmentMappings.json |
| 200 | deleteAssignmentMapping | (id: number) → Promise<void> | Impl | Impl | useAssignmentMappings | assignmentMappings.json |
...
| SP-5 | SharePointDataService Chunk 5: Project Controls Modules — Replaced 19 stubs with live PnP/SP implementations (129→148 implemented, 83→64 stubs remaining of 221 total). Risk/Cost Management (4 methods): getRiskCostManagement (2-list parallel read Risk_Cost_Management + Risk_Cost_Items, category-split assembly into buyoutOpportunities/potentialRisks/potentialSavings), updateRiskCostManagement (find-by-projectCode + conditional partial update + re-assemble), addRiskCostItem (parent FK lookup + create), updateRiskCostItem (conditional update + re-read). Quality Concerns (3 methods): getQualityConcerns (flat array read), addQualityConcern, updateQualityConcern. Safety Concerns (3 methods): getSafetyConcerns, addSafetyConcern, updateSafetyConcern. Schedule & Critical Path (3 methods): getProjectSchedule (2-list parallel read Project_Schedule + Critical_Path_Items), updateProjectSchedule (conditional partial update + re-assemble), addCriticalPathItem (parent FK lookup + create). Superintendent Plan (3 methods): getSuperintendentPlan (2-list read Superintendent_Plan + Superintendent_Plan_Sections by planId), updateSuperintendentPlanSection (section update + parent lastUpdatedAt), createSuperintendentPlan (create parent + sequential section creation + re-assemble). Lessons Learned (3 methods): getLessonsLearned (flat read with JSON.parse for tags), addLessonLearned (JSON.stringify for tags), updateLessonLearned. 9 new private mapper helpers added (mapToRiskCostManagement, mapToRiskCostItem, mapToQualityConcern, mapToSafetyConcern, mapToProjectSchedule, mapToCriticalPathItem, mapToSuperintendentPlan, mapToSuperintendentPlanSection with JSON.parse for attachmentUrls, mapToLessonLearned with JSON.parse for tags). All methods use `_getProjectWeb()` for cross-site project list access. | (none) | SharePointDataService.ts (19 stubs→implementations, +9 column mapping imports, +9 private mapper helpers), CLAUDE.md (§7, §15, §16) |

| SP-6 | SharePointDataService Chunk 6: Hub-Level CRUD & Reference Data — Replaced 21 stubs with live PnP/SP implementations (148→169 implemented, 67→46 stubs remaining of 221 total). Estimating Kickoff (8 methods): getEstimatingKickoff (2-list parallel read Estimating_Kickoffs + Estimating_Kickoff_Items, parent-child assembly with JSON.parse KeyPersonnel), getEstimatingKickoffByLeadId (same pattern, filter by LeadID), createEstimatingKickoff (create parent + batch-create items, JSON.stringify keyPersonnel/assignees), updateEstimatingKickoff (update parent + optionally replace items via delete+recreate), updateKickoffItem (child update + parent ModifiedDate touch), addKickoffItem (child create + parent ModifiedDate touch), removeKickoffItem (recycle child + parent ModifiedDate touch), updateKickoffKeyPersonnel (JSON.stringify personnel to parent). Job Number Requests (4 methods): getJobNumberRequests (optional status filter, orderBy RequestDate desc), getJobNumberRequestByLeadId (filter + top 1), createJobNumberRequest (create + link to lead via JobNumberRequestId), finalizeJobNumber (status transition Pending→Completed + update lead ProjectCode+OfficialJobNumber). Reference Data (2 methods): getProjectTypes (simple read-all), getStandardCostCodes (simple read-all, string id). Sector Definitions (3 methods): getSectorDefinitions (orderBy sortOrder), createSectorDefinition (auto-generate code from label, auto-increment sortOrder), updateSectorDefinition (conditional partial update). Assignment Mappings (4 methods): getAssignmentMappings (reassemble nested assignee from 3 flat SP columns), createAssignmentMapping (flatten assignee into 3 columns), updateAssignmentMapping (conditional update with assignee flattening), deleteAssignmentMapping (recycle). 7 private mapper helpers added (mapToEstimatingKickoff, mapToEstimatingKickoffItem, mapToJobNumberRequest, mapToProjectType, mapToStandardCostCode, mapToSectorDefinition, mapToAssignmentMapping). New column mapping: SECTOR_DEFINITIONS_COLUMNS. | (none) | SharePointDataService.ts (21 stubs→implementations, +7 column mapping imports, +2 model imports, +7 private mapper helpers), columnMappings.ts (+SECTOR_DEFINITIONS_COLUMNS), CLAUDE.md (§7, §15, §16) |

| SP-7 | SharePointDataService Chunk 7: Project Management Plan (PMP) — Replaced 7 stubs with live PnP/SP implementations (169→176 implemented, 46→39 stubs remaining of 221 total). PMP CRUD (5 methods): getProjectManagementPlan (4-list parallel read Project_Management_Plans + PMP_Signatures + PMP_Approval_Cycles + PMP_Approval_Steps, assemblePMPFromParts with signature type split + cycle-step nesting + 9 JSON.parse fields), updateProjectManagementPlan (find-by-projectCode + conditional partial update with JSON.stringify for 9 aggregate fields + re-assemble), submitPMPForApproval (getDivisionApprovers from hub, create approval cycle + 1-2 steps, update parent status to PendingApproval), respondToPMPApproval (update step status + cascade: rejected→cycle Returned + PMP Returned, all approved→cycle Approved + PMP Approved), signPMP (verify signature belongs to PMP + update status/date/comment). Reference Data (2 methods): getDivisionApprovers (hub-site simple read-all), getPMPBoilerplate (hub-site read-all ordered by sectionNumber). 7 private mapper helpers added (mapToPMP with 9 JSON.parse fields, mapToPMPSignature with boolean coercion, mapToPMPApprovalCycle with JSON.parse changesFromPrevious, mapToPMPApprovalStep, mapToDivisionApprover, mapToPMPBoilerplateSection, assemblePMPFromParts). 2 new column mappings: DIVISION_APPROVERS_COLUMNS, PMP_BOILERPLATE_COLUMNS. 2 new HUB_LISTS constants. | (none) | SharePointDataService.ts (7 stubs→implementations, +6 column mapping imports, +2 model imports, +7 private helpers incl. assemblePMPFromParts), columnMappings.ts (+DIVISION_APPROVERS_COLUMNS, +PMP_BOILERPLATE_COLUMNS), constants.ts (+DIVISION_APPROVERS, +PMP_BOILERPLATE in HUB_LISTS), CLAUDE.md (§7, §13, §15, §16) |
...
- **SharePointDataService**: 39 of 221 methods are stubs (+ 6 delegation stubs). Breakdown: 9 Pattern A stubs (`[STUB]` console.warn + empty return), 30 Pattern B stubs (`implementation pending` throw), 6 delegation stubs (intentionally delegate to GraphService/PowerAutomate — will never be SP list operations). Remaining stubs: all monthly review (4), all turnover agenda (16), scorecard workflow (7 — submit/respond/enterCommittee/recordFinal/unlock/relock/getVersions), scorecard archive (2 — reject/archive), action inbox (1), performance monitoring (3 — logPerformanceEntry/getPerformanceLogs/getPerformanceSummary), help guides (3 Pattern A reads + 1 Pattern B mutation — getHelpGuides/getHelpGuideById/getSupportConfig/updateHelpGuide), support (2 — sendSupportEmail/updateSupportConfig). `setProjectSiteUrl()` is implemented (creates cross-site Web via `_getProjectWeb()`). All Pattern A stubs log `console.warn('[STUB] methodName not implemented')`. All Pattern B stubs throw `Error('SharePoint implementation pending: methodName')`. Delegation stubs: getCalendarAvailability, createMeeting, getMeetings (→GraphService), sendNotification, getNotifications (→PowerAutomate), purgeOldAuditEntries (→Power Automate scheduled flow).
- **HubNavigationService**: SharePointHubNavigationService is a stub (all 3 methods throw).
- **Column Mappings**: `columnMappings.ts` has mappings for all lists. Permission Templates, Security Group Mappings, Project Team Assignments, Provisioning Log, Workflow Definitions (4 lists), Startup Checklist, Checklist Activity Log, Internal Matrix, Team Role Assignments, Owner Contract Matrix, Sub Contract Matrix, Marketing Project Records, Estimating Kickoffs, Estimating Kickoff Items, Job Number Requests, Project Types, Standard Cost Codes, Sector Definitions, Assignment Mappings, PMP (4 lists), Division Approvers, and PMP Boilerplate now use column mappings in SharePointDataService.
...
- **Implemented (176 of 221)**: Leads CRUD, Go/No-Go CRUD (base 5), Estimating CRUD, Roles/Flags CRUD, Audit log/read, **Provisioning CRUD** (trigger/update/retry/read/list), Phase 6 workflow (team, deliverables, interview, contract, turnover items, closeout, loss autopsy — 17 methods), Buyout/Commitment/Compliance, Active Projects Portfolio, AppContextConfig, hub site URL read/write, **getCurrentUser** (Phase 31), **Permission Templates CRUD** (5), **Security Group Mappings CRUD** (3), **Project Team Assignments CRUD + soft delete** (7), **inviteToProjectSiteGroup** (fire-and-forget SP group add), **resolveUserPermissions** (full resolution chain), **getAccessibleProjects** (computed), **getEnvironmentConfig** (with fallback), **promoteTemplates** (batch update + config write), **BD Leads folder ops** (create/check/mkdir/rename via cross-site Web()), **syncDenormalizedFields** (5-list batch), **promoteToHub** (cross-site lessons + PMP close), **rekeyProjectCode** (6-list batch), **Workflow Definitions CRUD** (10 — definitions read/assembly, step/conditional mutations, override upsert, resolveWorkflowChain 4-tier resolution), **Startup Checklist CRUD** (4 — 2-list join for reads with activity log grouping), **Internal Matrix CRUD** (4), **Team Role Assignments** (2 — upsert by role), **Owner Contract Matrix CRUD** (4), **Sub-Contract Matrix CRUD** (4), **Marketing Project Records CRUD** (4 — 88-column mapping with JSON array parse/stringify), **Risk/Cost Management** (4 — 2-list parallel read with category-split assembly), **Quality Concerns CRUD** (3 — flat array with letter ordering), **Safety Concerns CRUD** (3 — flat array with severity/officer fields), **Schedule & Critical Path** (3 — 2-list parallel read with child nesting), **Superintendent Plan** (3 — parent-child with JSON.parse for attachmentUrls, sequential section creation), **Lessons Learned CRUD** (3 — flat array with JSON.parse/stringify for tags), **Estimating Kickoff CRUD** (8 — parent-child 2-list read with JSON.parse KeyPersonnel/Assignees, item replacement via delete+recreate), **Job Number Requests CRUD** (4 — status filter, cross-list lead update on finalize), **Reference Data** (2 — getProjectTypes, getStandardCostCodes), **Sector Definitions CRUD** (3 — auto-generate code, auto-increment sortOrder), **Assignment Mappings CRUD** (4 — nested assignee ↔ 3 flat SP columns), **PMP CRUD** (7 — 4-list parallel read with signature type split + cycle-step nesting + 9 JSON.parse fields, approval chain creation with division approver lookup, approval cascade step→cycle→parent, signature update with PMP ownership verification, hub-site reference data reads for Division_Approvers + PMP_Boilerplate)
...
- **Stubbed (39)**: all monthly review (4), all turnover agenda (16), scorecard workflow (7 — submit/respond/enterCommittee/recordFinal/unlock/relock/getVersions), scorecard archive (2 — reject/archive), action inbox (1), performance monitoring (3 — logPerformanceEntry/getPerformanceLogs/getPerformanceSummary), help guides (3 reads + 1 mutation — getHelpGuides/getHelpGuideById/getSupportConfig/updateHelpGuide), support (2 — sendSupportEmail/updateSupportConfig)
...
88. **JSON array fields in SP lists require safe parse/stringify** — `attachmentUrls` (ISuperintendentPlanSection) and `tags` (ILessonLearned) are stored as JSON-stringified arrays in SP Multi-Line Text columns. On read, mappers use `try { JSON.parse(raw) } catch { [] }` with type guard (`typeof raw === 'string' && raw`). On write, values are `JSON.stringify(array)`. Array fields from SP may also arrive as actual arrays (if SharePoint returns JSON natively), so mappers also handle `Array.isArray(raw)` as a fallback. Never assume these fields are always strings or always arrays — check both.

89. **Risk/Cost Management uses category-split assembly** — `getRiskCostManagement` reads a single parent from `Risk_Cost_Management` and all child items from `Risk_Cost_Items` in parallel, then splits children by `category` field ('Buyout'/'Risk'/'Savings') into three typed arrays. The parent mapper returns empty arrays for these three fields — the assembly step after mapping fills them. This is different from Schedule/Superintendent which nest children under a single array field.

90. **`getSuperintendentPlan` filters sections by `superintendentPlanId` (not `projectCode`)** — Unlike most parent-child reads that filter children by `projectCode`, superintendent plan sections are filtered by `superintendentPlanId` (the parent's SP item ID). This matches the MockDataService pattern where `assembleSuperintendentPlan` joins on `s.superintendentPlanId === plan.id`. The parent is still found by `projectCode`. This is important because a project could theoretically have archived plan records.

91. **Estimating Kickoff item replacement uses delete+recreate** — `updateEstimatingKickoff` with `data.items` provided deletes ALL existing items for the kickoff (via filter + `.recycle()` each), then recreates all items from the provided array. This is a full replacement, not a merge. The caller must include ALL desired items in the array, not just changed ones. This matches the MockDataService pattern where items are fully replaced on parent update. Parent `ModifiedDate` is touched after item operations.

92. **`finalizeJobNumber` updates both Job_Number_Requests and Leads_Master** — The `finalizeJobNumber` method reads the request to get `LeadID`, updates the request status to `Completed` with `AssignedJobNumber`, then updates the linked lead's `ProjectCode` and `OfficialJobNumber` fields. The lead update is wrapped in try/catch as non-critical (the request status change is the primary mutation). If the lead update fails (e.g., lead deleted), the job number request still transitions to Completed.

93. **Assignment Mapping assignee is 3 flat SP columns → 1 nested object** — `IAssignmentMapping.assignee` is `{ userId, displayName, email }` in the TypeScript model, but stored as 3 separate SP columns: `AssigneeUserId`, `AssigneeDisplayName`, `AssigneeEmail`. The `mapToAssignmentMapping` mapper reassembles the nested object on read. `createAssignmentMapping` and `updateAssignmentMapping` flatten it back. When writing, always check if `data.assignee` exists before flattening — partial updates may not include assignee changes.

94. **PMP uses 4-list parallel read + assembly** — `getProjectManagementPlan` reads from `Project_Management_Plans` (parent), `PMP_Signatures`, `PMP_Approval_Cycles`, and `PMP_Approval_Steps` in parallel (3 child reads after parent found). The `assemblePMPFromParts` helper splits signatures by `signatureType` ('Startup'/'Completion') and nests steps under their cycles by `approvalCycleId`. The parent mapper `mapToPMP` JSON.parse's 9 aggregate fields (attachmentUrls, riskCostData, qualityConcerns, safetyConcerns, scheduleData, superintendentPlanData, lessonsLearned, teamAssignments, boilerplate) with safe try/catch fallbacks.

95. **PMP approval cascading: step → cycle → parent** — `respondToPMPApproval` updates a single step, then evaluates the entire cycle: if ANY step is `'Returned'`, the cycle becomes `'Returned'` and PMP status becomes `'Returned'`. Only when ALL steps are `'Approved'` does the cycle become `'Approved'` and PMP status becomes `'Approved'`. The method handles race conditions by explicitly checking `stepId` equality (the just-updated step may still show old status in the re-read, so it's treated as approved).

96. **`getDivisionApprovers` and `getPMPBoilerplate` read from hub site** — Unlike the 5 PMP CRUD methods that use `_getProjectWeb()` for project-site lists, the 2 reference data methods (`getDivisionApprovers`, `getPMPBoilerplate`) read from the hub site via `this.sp.web`. `Division_Approvers` and `PMP_Boilerplate` are hub-level lists, NOT project-site lists. Do not use `_getProjectWeb()` for these reads.
...
| 2026-02-15 | §7, §15, §16 | SP Service Chunk 5: Project Controls Modules. §7: 19 methods changed from SP Stub→Impl (methods 78-96). §15: Phase SP-5 entry added. SharePointDataService status updated: 148 implemented / 67 stubs. Known Stubs updated (removed risk/cost, quality, safety, schedule, superintendent, lessons). §16: Added pitfalls #88-90 (JSON array fields safe parse, risk/cost category-split assembly, superintendent plan sections filtered by planId not projectCode). Files modified: SharePointDataService.ts (+9 column mapping imports, 19 stub→implementations, +9 private mapper helpers), CLAUDE.md (§7, §15, §16). |
| 2026-02-15 | §2, §7, §15, §16 | SP Service Chunk 6: Hub-Level CRUD & Reference Data. §2: SharePointDataService stub count 129→169 impl, 84→46 stubs. §7: 21 methods changed from SP Stub→Impl (methods 108-114, 115-120, 173, 190-192, 197-200). §15: Phase SP-6 entry added. SharePointDataService status updated: 169 implemented / 46 stubs. Known Stubs updated (removed estimating kickoff, job number requests, reference data, sector definitions, assignment mappings). Column Mappings note updated (+7 lists). §16: Added pitfalls #91-93 (kickoff item replacement delete+recreate, finalizeJobNumber cross-list lead update, assignment mapping assignee flattening). Files modified: SharePointDataService.ts (+7 column mapping imports, +2 model imports, 21 stub→implementations, +7 private mapper helpers), columnMappings.ts (+SECTOR_DEFINITIONS_COLUMNS), CLAUDE.md (§2, §7, §15, §16). |
| 2026-02-15 | §7, §13, §15, §16 | SP Service Chunk 7: Project Management Plan (PMP). §7: 7 methods changed from SP Stub→Impl (methods 97-103). §13: +2 HUB_LISTS (DIVISION_APPROVERS, PMP_BOILERPLATE). §15: Phase SP-7 entry added. SharePointDataService status updated: 176 implemented / 39 stubs. Known Stubs updated (removed PMP). Column Mappings note updated (+6 lists: PMP 4 lists + Division Approvers + PMP Boilerplate). §16: Added pitfalls #94-96 (PMP 4-list assembly, approval cascading step→cycle→parent, getDivisionApprovers/getPMPBoilerplate hub reads). Files modified: SharePointDataService.ts (+6 column mapping imports, +2 model imports, 7 stub→implementations, +7 private helpers incl. assemblePMPFromParts), columnMappings.ts (+DIVISION_APPROVERS_COLUMNS, +PMP_BOILERPLATE_COLUMNS), constants.ts (+2 HUB_LISTS), CLAUDE.md (§7, §13, §15, §16). |
