 ...
 *
 * PERMANENT MACHINE PATH (Stage 12):
 * - Workflow machines are the default execution path in UI.
 * - Machines are loaded lazily via getAsync() into lib-xstate-workflow chunk.
