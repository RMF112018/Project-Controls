...
export enum AuditAction {
  ...
  ScheduleReconciliationPreviewed = 'Schedule.ReconciliationPreviewed',
  ScheduleReconciliationApplied = 'Schedule.ReconciliationApplied',
  ScheduleActivityUpdated = 'Schedule.ActivityUpdated',
  ScheduleActivityDeleted = 'Schedule.ActivityDeleted',
  ScheduleFieldLinkCreated = 'Schedule.FieldLinkCreated',
  ScheduleFieldLinkUpdated = 'Schedule.FieldLinkUpdated',
  ScheduleFieldLinkDeleted = 'Schedule.FieldLinkDeleted',
  ScheduleConflictResolved = 'Schedule.ConflictResolved',
  ScheduleBaselineCreated = 'Schedule.BaselineCreated',
...
export enum EntityType {
  ...
  ScheduleFieldLink = 'ScheduleFieldLink',
